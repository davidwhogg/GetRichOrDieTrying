...
(\acronym{RMS} around the mean, say) smaller than $1\,\mps$.
...
be seeing 0.3-ish $\mps$ around certain very quiet stars. That's exciting
...
Make the point that instrument calibration looks good in the new generation
of instruments...

Then make the point that you can't stabilize the star!

So in our view, stellar variability is the tall pole for EPRV. Say it loud.

(then Extensive words about how data-driven models are changing stellar science, and
that we two are at the forefront of that.)

In our view, you have to solve these problems data-driven.
...
HOGG Summarize the point that variability is the tall pole, and we intend to shorten it.
