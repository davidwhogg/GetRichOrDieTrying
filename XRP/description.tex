...
directly supported 24 papers in the astrophysics literature, on a
range of subjects from modeling images to measuring stars in addition
to the direct work on the \GALEX\ data to pedagogical contributions
on computational data analysis.
