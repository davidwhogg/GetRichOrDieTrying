...
as part of the \NASA\ \NNEXPLORE\ program.
...
in the box on page~\pageref{eq:fisher},
...
HOGG GET MORE SPECIFIC HERE ABOUT WHAT ONE OF THESE MODELS OR
APPROACHES MIGHT LOOK LIKE. PERHAPS STAR SPOTS AS AN EXAMPLE.
...
It resulted in a paper (\citealt{CPMdiff}), a codebase (HOGG GitHub link),
and a set of methods that were deployed in the \Ktwo\ microlensing campaign (\citealt{K2C9}).
