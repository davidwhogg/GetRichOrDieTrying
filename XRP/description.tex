...
BEDELL: BE BOLD, EDIT. DON'T COMMENT, EDIT! THANK YOU AND I OWE YOU DRINKS.
\begin{itemize}
\item
...
\ESPRESSO\ (CITE) and the Yale spectrograph \EXPRES\ (CITE) might both
...
...We will do experiments on \HARPS\ data in hand. Maybe other data if it
starts to appear, like \ESPRESSO\ and \NEID....

...paragraph about engineering trade-offs for short exposures...

...Deliverables here will be strategies, methods, and associated
open-source code. And two papers which are some refactoring of the
strategies above....
