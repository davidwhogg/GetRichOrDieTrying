...
and variance.
(For the purposes of this proposal, I am going to equate what a
statistician calls a ``bias'' with what a cosmologist calls a
``systematic error'' and what a statistician calls ``variance'' with
the inverse of what a cosmologist calls ``preicision''.  I will
...
specific angular position or redshift of any individual galaxy in the
density field.
These galaxy positions constitute an example of a \emph{very large}
set of nuisance parameters in any large-scale structure analysis.
...
auto-correlation function, and only then doing cosmological inference
