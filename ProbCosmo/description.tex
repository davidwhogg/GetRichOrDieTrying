...
methods.
We will write a theory and method-oriented paper, and a data and
results paper on this toolset.
We will also release the toolset as documented, MIT-licensed,
open-source code.
...
also 
...
Again, \package{Toolset~2} will perform this hierarchical inference.

...re-infer the LRG LF and BAO using SDSS imaging but only photometric redshifts
